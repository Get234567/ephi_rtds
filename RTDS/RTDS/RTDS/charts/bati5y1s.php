                ...
                <div class="card card-info">
                  ...
                  <div class="col-12" id="container31">
                      ...
                      <div class="col-12" id="container41">
                          ...
                          <div class="col-12" id="container61">
                              <div class="card card-primary">
                                <div class="card card-info">
                                  <div class="card-header">
                                    <h3 class="card-title">  </h3>
                                  ...
                                  <div class="card-body">
                                    <div class="chart">
                                          ...
                                          <figure class="highcharts-figure">
                                              <div id="container61" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 250%;"></div>
                                              <p class="highcharts-description">
                          ...
                          <div class="col-12" id="container51">
                              <div class="card card-primary">
                                <div class="card card-info">
                                  <div class="card-header">
                                    <h3 class="card-title">  </h3>
                              ...
                              <div class="col-12" id="container71">
                                  <div class="card card-primary">
                                    <div class="card card-info">
                                      <div class="card-header">
                                        <h3 class="card-title">  </h3>
                                      ...
                                      <div class="card-body">
                                        <div class="chart">
                                              ...
                                              <figure class="highcharts-figure">
                                                  <div id="container71" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 250%;"></div>
                                                  <p class="highcharts-description">
...
var chart = Highcharts.chart('container41', {
    ...
    title: {
        text: 'A total of 47 schools and 38 health facilities were censused as part of the Geshiyaro census (October to December 2018). The ‘Guide’ count for the schools/health facilities is the number of schools or health facilities stated as being in the woreda. (year 1)  '
    },

    subtitle: {
        text: 'Number of health facilities and schools in Bolosso Sore'
    },
    ...
    xAxis: {
        categories: ["Health centre","Health Post","Private clinic","School"],
        labels: {
            x: -10
        }
    },
...
var chart = Highcharts.chart('container51', {
    ...
    title: {
        text: 'All health care centres had clean latrines and separate latrines for staff and patients (year 1)  '
    },
    ...
    xAxis: {
        categories: ["Korke doge","Adama mino","Dache gofara","Tiyo hembecho","Wormuma","Achura Mazegaja","Gurmo koysha Mazegaja","Dola"],
        labels: {
            x: -10
        }
    },
    ...
    series: [{
        name: 'Total number of health facilities',
        data: [1,1,2,1,2,1,2,1]
    }, {
        name: 'Presence of latrines',
        data: [1,1,2,1,2,1,2,1]
    } , {
        name: 'Are the latrines clean (%)',
        data: [100,100,100,100,100,100,100,100]
    }, {
        name: 'Are the separate latrines for staff and patients (%)',
        data: [100,100,100,100,100,100,100,100]
    }],
...
var chart = Highcharts.chart('container61', {
    ...
    title: {
        text: 'All schools in Achura Mazagaja and 1 school from Wormmuma did not have latrines (year 1)  '
    },
    ...
    xAxis: {
        categories: ["Korke doge","Adama mino","Basa Gofara","Dache gofara","Gara Goda","Admancho Arfita","Tiyo hembecho","Wormuma","Achura Mazegaja","Gurmo koysha Mazegaja","Dola"],
        labels: {
            x: -10
        }
    },
    ...
    series: [{
        name: 'Number of schools surveyed',
        data: [2,2,1,1,2,1,2,3,2,2,1]
    }, {
        name: 'Number of latrines',
        data: [2,2,1,1,2,1,2,2,0,2,1]
    } , {
        name: 'Number of clean latrines',
        data: [2,1,1,1,0,1,2,2,0,2,1]
    }],
...
var chart = Highcharts.chart('container71', {
    ...
    title: {
        text: 'The charts below records the total number of households in the surveyed kebeles and the number of community latrines. As the time of reporting, we provide data for six out of 12 kebeles. (year 1)  '
    },
    ...
    xAxis: {
        categories: ["Korke doge","Adama mino","Dache gofara","Admancho Arfita","Wormuma","Dola"],
        labels: {
            x: -10
        }
    },
    ...
    series: [{
        ...
        data: [1438,1200,1031,1219,1310,850]
    }, {
        name: 'Reported number of community latrines',
        data: [18,11,4,4,9,13]
    }],
