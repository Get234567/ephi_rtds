        ...
        <div class="row">
            ...
            <div class="card card-primary">
              <div class="card card-info">
                <div class="card-header">
                  <h3 class="card-title"> Treatment coverage ALB/PZQ year 1 </h3>
              ...
              <!-- /.card-body -->
                          ...
                          <div class="card-header">
                            <h3 class="card-title">Treatment coverage praziquantel year 1</h3>
                          </div>
                          <!-- /.card-header -->
                          <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card card-success">
                <div class="card-header">
                  <h3 class="card-title"> Treatment coverage by age group year2 </h3>
              ...
              <!-- /.card-body -->
                ...
                <div class="card card-primary">
                  <div class="card card-success">
                    <div class="card-header">
                      <h3 class="card-title"> Treatment coverage by age group year1 </h3>
