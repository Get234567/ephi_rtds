...
<div class="wrapper">
  ...
  <nav class="navbar navbar-expand navbar-fff888 navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index.php" scrollTo="portfolio" class="nav-link">Partners</a>
      </li>
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <p>
 The prevalence and intensity of Schistosoma mansoni, Hookworm, Trichuris, Ascaris and Schistosoma haematobium were investigated within the community from pre-school aged children (SAC) until adults.
                     </p>
