...
<head>
  ...
  <title>RTDS | Health Data Repository and Research Tracking System</title>
  ...
  <link href="css/font-awesome.min1849.css" rel="stylesheet">
  <style>
    #loader {
  ...
  <head>
    ...
    <style>
      * {
        ...
        padding: 0;
        box-sizing: border-box;
        font-family: Ubuntu Mono, "Helvetica Neue", Helvetica, Arial, sans-serif !important;
      ...
      .headerw {
        display: flex;
        z-index: 9999999999 !important;
        background-image: linear-gradient(90deg, #86de61, #0f6d0ff5);
      ...
      .nav-menu ul {
        ...
        top: 2rem;
        border-bottom: 0.2rem rgb(0, 255, 64) solid;
      }
              ...
              <li><a href="#" data-toggle="modal" data-target="" class=" dropdown-toggle dropdown ">Publications</a>
                <ul class="subList">
                  ...
                  <li><a href="https://forum.ephi.gov.et/index.php" target="_blank">Published
                      articles </a></li>
                  <li> <a href="#" data-toggle="modal" data-target="#">Technical
                      Reports</a></li>
                  <li><a href="#" data-toggle="modal" data-target="#">Guidelines and
                      Protocols</a></li>
                  <li> <a href="#" data-toggle="modal" data-target="#">Government Documents</a>
                  </li>
    ...
    <div id="carousel-fade" class="carousel carousel-fade" data-ride="carousel" data-interval="5000"
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="redcap_slider.png" class="d-block w-100" alt="...">
        ...
        <div class="carousel-item">
          <img src="cspro_slider.png" class="d-block w-100" alt="...">
          <div class="carousel-caption d-none d-md-block"
            style="background-color: rgb(49, 181, 84,0.0); color: rgb(200,200,200);">
            <h4
              style="font-family: 'Dosis', sans-serif; background-color: rgb(0,0,0,0.85); padding-top: 5px; padding-bottom: 5px;">
                  ...
                  <div class="row row-cols-1 row-cols-md-4 g-4">
                    <div class="col">
                      <div class="card h-100">
                        <img src="redcap_card.png" class="card-img-top" alt="..." />
                        <div class="card-body">
                    ...
                    <div class="col">
                      <div class="card h-100">
                        <img src="dhis2_card.png" class="card-img-top" alt="..." />
                        <div class="card-body">
                    ...
                    <div class="col">
                      <div class="card h-100">
                        <img src="cspro_card.png" class="card-img-top" alt="..." />
                        <div class="card-body">
                    ...
                    <div class="col">
                      <div class="card h-100">
                        <img src="odk_card.png" class="card-img-top" alt="..." />
                        <div class="card-body">
      ...
      <div class="footer">
        ...
        <div class=main-footer>
          ...
          <div class="col-two">
            ...
            <li><a href="https://ndmc.ephi.gov.et/" target="_blank"> NDMC</a></li>
          <li><a href="https://vizhub.ephi.gov.et/" target="_blank"> H-DAV</a></li>
              <li><a href="https://vizhub.ephi.gov.et/lan/index_comments.php" target="_blank"> COVID-19 Modelling</a></li>
          <li><a href="https://survey.ephi.gov.et/" target="_blank"> Data Sharing</a></li>
                <li><a href="https://ephi.gov.et/" target="_blank"> EPHI</a></li>
        <li><a href="https://www.moh.gov.et/ejcc/" target="_blank">FMOH </a></li>
            <li><a href="https://dhis.moh.gov.et/" target="_blank"> DHIS2</a></li>
            <li><a href="https://africacdc.org/" target="_blank"> Africa CDC </a></li>
        <li><a href="http://ghdx.healthdata.org/" target="_blank"> IHME</a></li>
